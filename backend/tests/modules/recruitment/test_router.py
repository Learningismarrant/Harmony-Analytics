...
def _match_row():
    return {
        ...
        "filtered_at": None,
        "profile_fit": {"g_fit": 72.0, "safety_level": "CLEAR", "safety_flags": [], "fit_label": "GOOD_FIT",
                        "overall_centile": 65.0, "centile_by_competency": {}},
        "team_integration": {"available": True, "y_success": 65.0, "success_label": "GOOD_FIT",
                             "p_ind": 70.0, "f_team": 65.0, "f_env": 60.0, "f_lmx": 70.0,
                             "team_delta": 2.0, "confidence": "HIGH"},
        "name": "Jean Marin",
        "avatar_url": None,
        "location": None,
        "experience_years": 2,
