...
export function SociogramCanvas({
  ...
  // ── Build / rebuild simulation when sociogram data changes ──────────────────
  useEffect(() => {
    ...
    const { simulation, physicsNodes: pNodes, physicsEdges: pEdges } =
      buildSimulation(sociogram.nodes, sociogram.edges);
  ...
  return (
    <div className={`relative ${className}`}>
      <Canvas
        ...
        style={{ background: "radial-gradient(ellipse at center, #0D1B2A 0%, #07090F 100%)" }}
      >
